...
# Default-Stop:         0 1 6
# Short-Description:    start traintimer
# Description:          start traintimer
### END INIT INFO
#
# Based on:
...
APPLICATION_DIRECTORY=/var/www/opensource/opensportproject/vlcstart/
APPLICATION_START=serverlvc.js
PIDFILE=/var/run/vlc-forever.pid
LOGFILE=/var/log/vlc-forever.log
